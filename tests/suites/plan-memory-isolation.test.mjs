...
import { click, openApp, createBlankEvent, importPlan, runDetection, reRunDetection, ocrAvailability, futureDate } from "../lib/app-actions.mjs";
...
export default async function run({ page, checks, baseUrl, repoRoot }) {
  ...
  await createBlankEvent(page, { name: "Memory", hotel: "Merit", date: futureDate() });
