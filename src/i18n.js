(() => {
  ...
  const STRINGS = {
    ...
    "live.kpi.notArrived": { en: "Not Arrived", tr: "Gelmedi" },
    "live.kpi.notArrivedNote": { en: "Awaiting arrival", tr: "Varış bekleniyor" },
    "live.kpi.noShow": { en: "No Show", tr: "Gelmeyen" },
    ...
    "status.arrival.Not Arrived": { en: "Not Arrived", tr: "Gelmedi" },
    "status.arrival.Checked In": { en: "Checked In", tr: "Giriş Yaptı" },
    "status.arrival.No Show": { en: "No Show", tr: "Gelmedi (No Show)" },
