(() => {
  ...
  const STRINGS = {
    ...
    "renderFailed.title": { en: "This screen could not be shown", tr: "Bu ekran gösterilemedi" },
    "renderFailed.body": { en: "Nothing was changed or lost — your event is still in memory. Go back to the events list, or download a backup of everything first.", tr: "Hiçbir şey değişmedi ya da kaybolmadı — etkinliğiniz hâlâ bellekte. Etkinlik listesine dönün ya da önce her şeyin yedeğini indirin." },
    "renderFailed.toEvents": { en: "Back to the events list", tr: "Etkinlik listesine dön" },
    "analysis.stage.failed": { en: "Analysis could not finish", tr: "Analiz tamamlanamadı" },
    ...
    // The product's own confirm / number dialog (src/app.js ask()).
    "ask.confirm": { en: "Continue", tr: "Devam et" },
    "ask.cancel": { en: "Cancel", tr: "Vazgeç" },
    "ask.delete": { en: "Delete", tr: "Sil" },
    "ask.restore": { en: "Restore", tr: "Geri yükle" },
    "ask.import": { en: "Import", tr: "İçe aktar" },
    "ask.set": { en: "Set", tr: "Uygula" },
    "ask.usePage": { en: "Use this page", tr: "Bu sayfayı kullan" },
    "ask.numberRange": { en: "Enter a whole number from {min} to {max}.", tr: "{min} ile {max} arasında bir tam sayı girin." },
    "ask.deleteEventTitle": { en: "Delete this event?", tr: "Bu etkinlik silinsin mi?" },
    "ask.deleteEventBody": { en: "\u201c{name}\u201d and everything in it will be deleted. This cannot be undone.", tr: "\u201c{name}\u201d ve içindeki her şey silinecek. Bu geri alınamaz." },
    "ask.deleteGuestTitle": { en: "Delete this guest?", tr: "Bu misafir silinsin mi?" },
    "ask.deleteObjectsTitle": { en: "Delete {n} selected object(s)?", tr: "Seçili {n} nesne silinsin mi?" },
    "ask.deleteObjectsGuests": { en: "{guests} guest record(s) seated there will return to Unassigned — the records themselves are kept.", tr: "Orada oturan {guests} misafir kaydı Atanmamış'a döner — kayıtların kendisi korunur." },
    "ask.restoreTitle": { en: "Replace every event with this backup?", tr: "Tüm etkinlikler bu yedekle değiştirilsin mi?" },
    "ask.importTitle": { en: "Import this event?", tr: "Bu etkinlik içe aktarılsın mı?" },
    "ask.recoveryTitle": { en: "Restore the automatic snapshot?", tr: "Otomatik anlık görüntü geri yüklensin mi?" },
    "ask.seatsTitle": { en: "Custom seat count", tr: "Özel koltuk sayısı" },
    "ask.seatsBody": { en: "How many seats does {number} have?", tr: "{number} kaç koltuklu?" },
    "ask.seatsLabel": { en: "Seats", tr: "Koltuk" },
    "ask.pdfPageTitle": { en: "Which page is the floor plan?", tr: "Kat planı hangi sayfada?" },
    "ask.pdfPageBody": { en: "This PDF has {n} pages.", tr: "Bu PDF {n} sayfadan oluşuyor." },
    "ask.pdfPageLabel": { en: "Page number", tr: "Sayfa numarası" },
    ...
    // Storage notices: what happened, what was NOT lost, what to do next.
    "storage.unreadableTitle": { en: "The saved data on this computer could not be read", tr: "Bu bilgisayardaki kayıtlı veriler okunamadı" },
    "storage.unreadableKept": { en: "It was not opened, and it was not deleted: the original is kept as a separate copy ({when}). Restore from a backup, or download the copy for support to repair.", tr: "Açılmadı ve silinmedi: orijinali ayrı bir kopya olarak saklandı ({when}). Bir yedekten geri yükleyin ya da kopyayı indirip onarım için destek ekibine gönderin." },
    "storage.unreadableNotKept": { en: "It could not even be copied aside, so this session will NOT save — saving would overwrite the only copy. Download it now, then restore from a backup.", tr: "Ayrı bir kopyası bile alınamadı; bu yüzden bu oturum KAYDETMEYECEK — kaydetmek tek kopyanın üzerine yazar. Hemen indirin, ardından bir yedekten geri yükleyin." },
    "storage.unavailable": { en: "The browser's storage could not be opened, so nothing saved on this computer could be read. This session will NOT save, so nothing stored there is overwritten. Reload the page; if this stays, restore from a backup.", tr: "Tarayıcı depolaması açılamadı, bu yüzden bu bilgisayarda kayıtlı hiçbir şey okunamadı. Bu oturum KAYDETMEYECEK; böylece orada saklanan hiçbir şeyin üzerine yazılmaz. Sayfayı yenileyin; sorun sürerse bir yedekten geri yükleyin." },
    "storage.downloadUnreadable": { en: "Download the unreadable record", tr: "Okunamayan kaydı indir" },
    "storage.restoreBackup": { en: "Restore from a backup", tr: "Yedekten geri yükle" },
    "storage.dismiss": { en: "Hide", tr: "Gizle" },
    "storage.saveFailingTitle": { en: "Changes are NOT being saved", tr: "Değişiklikler KAYDEDİLMİYOR" },
    "storage.saveFailingBody": { en: "The browser refused to store them. Your work is still on this screen — download a backup before closing it. This notice clears itself as soon as a save succeeds.", tr: "Tarayıcı saklamayı reddetti. Çalışmanız hâlâ bu ekranda — kapatmadan önce bir yedek indirin. Bir kayıt başarılı olduğu anda bu uyarı kendiliğinden kalkar." },
    "storage.downloadBackup": { en: "Download a backup now", tr: "Şimdi yedek indir" },
    ...
    "radar.doesNotCover": { en: "Not covered by this radar yet: {risks}.", tr: "Bu radarın henüz kapsamadıkları: {risks}." },
    "radar.notEvaluated.UNAVAILABLE_TABLES": { en: "a table taken out of service", tr: "servis dışı bırakılan bir masa" },

    "doctor.go.LIVE": { en: "Open in Live Event", tr: "Canlı Etkinlikte aç" },
    "doctor.go.BACKUP": { en: "Back up now", tr: "Şimdi yedekle" },
    "doctor.source.ARRIVALS": { en: "who has actually arrived", tr: "gerçekte kimlerin geldiği" },
    "doctor.source.BACKUP": { en: "the exported copy", tr: "dışa aktarılan kopya" },
    "doctor.affects.RECOVERY": { en: "recovery", tr: "geri kurtarma" },
    ...
    "doctor.neverBackedUp": { en: "no backup of this event has ever been taken", tr: "bu etkinliğin hiç yedeği alınmadı" },
    "doctor.neverBackedUp.why": { en: "everything this product knows lives in this browser — with no exported copy, clearing the browser's data ends the event", tr: "bu ürünün bildiği her şey bu tarayıcıda duruyor — dışa aktarılmış bir kopya yoksa, tarayıcı verisi silindiğinde etkinlik biter" },
    "doctor.backupOlderThanTheEvent": { en: "this event has changed since the last backup was taken", tr: "son yedekten bu yana bu etkinlik değişti" },
    "doctor.backupOlderThanTheEvent.why": { en: "the exported copy is older than the event's last modification — restoring it today would lose the work done since", tr: "dışa aktarılan kopya etkinliğin son değişikliğinden eski — bugün geri yüklenirse o günden beri yapılan işler kaybolur" },
    "doctor.chairsFreedByNoShow": { en: "{pax} chairs are physically free tonight that the table plan still shows as taken", tr: "masa planında dolu görünen {pax} koltuk bu gece fiilen boş" },
    "doctor.chairsFreedByNoShow.1": { en: "one chair is physically free tonight that the table plan still shows as taken", tr: "masa planında dolu görünen bir koltuk bu gece fiilen boş" },
    "doctor.chairsFreedByNoShow.why": { en: "a No Show keeps its planned seat on purpose — the plan and the reports are correct, and these chairs can still be used on the night", tr: "Gelmedi durumu planlanan koltuğu bilerek korur — plan ve raporlar doğrudur, bu koltuklar gece yine de kullanılabilir" },
